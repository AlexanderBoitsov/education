Задание состояло в том, чтобы дописать приложение, в котором можно было добавлять, просматривать и редактировать данные о книгах, и превратить его в платформу объявлений о продаже книг.
